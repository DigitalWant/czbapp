...
const actions = {
  [types.GET_SIG_ACTION]({ commit }, data) {
    return new Promise((resolve,reject)=>{
      miCourseRoom.getSig({ commit }, data, resolve, reject)
    })
  },
  [types.GET_CHANNEL_ACTION]({ commit }, data) {
    return new Promise((resolve,reject)=>{
      miCourseRoom.getChannel({ commit }, data, resolve, reject)
    })
  },
  ...
  [types.GET_PPT]({commit},data){
    return new Promise((resolve,reject)=>{
      miCourseRoom.getPPT({commit}, data, resolve, reject)
    })
  },
}
