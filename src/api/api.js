...
// export const API_ROOT = 'http://192.168.16.188:8099/czb-server'
...
// 3.0 agora
export const API_PATH_AGORA_GET_SIG = API_ROOT + '/czb/api/agora/getSignKey'
export const API_PATH_AGORA_GET_CHANNEL = API_ROOT + '/czb/api/agora/getChannelKey'
export const API_PATH_AGORA_POST_MESSAGE = API_ROOT + '/czb/api/agora/channel_sendmsg'

// 3.1 userId*|
export const API_PATH_GET_BOOKED_MI_COURSE_LIST = API_ROOT + '/czb/api/getTrainBooked'

// 3.2 get ppt
export const API_PATH_GET_PPT = API_ROOT + '/czb/api/getppt'
...
/* VIDEO SECTION */
// 6.0 video
export const API_PATH_GET_VIDEO_LIST = API_ROOT+'/czb/api/webCourse?source=web' //专业课程

// 6.1 program
export const API_PATH_GET_PROGRAM_LIST = API_ROOT+'/czb/api/program?source=web' //视频节目

// 6.2 video Tags
export const API_PATH_GET_TAGS = API_ROOT+'/czb/api/courseType?source=web' // 标签

// 6.3 video player eg.A9F771311583DFA89C33DC5901307461
export const API_PATH_GET_PLAYER_CODE = API_ROOT+'/czb/api/cc/getPlaycode' //获取播放器代码

// 6.4 video course base info
export const API_PATH_GET_VIDEO_BASE_INFO = API_ROOT+'/czb/api/getCourse?source=web&courseId='

// 6.5 video course reference info
export const API_PATH_GET_VIDEO_REF_INFO = API_ROOT+'/czb/api/subCourse?source=web&courseId='

// 6.6 video teacher info
export const API_PATH_GET_VIDEO_TEACHER_INFO = API_ROOT+'/czb/api/teacher?source=web&courseId='
