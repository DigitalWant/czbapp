<template lang="html">
  <div class="ui fluid container" style="background-color:#f5f5f5">
    <div class="ui container very padded tall stacked segment">
      <h2 class="ui header olive center aligned">请填写下面信息</h2>
        ...
        <el-form :model="userQuizForm" label-width="100px" ref="userQuizForm" :rules="rules">
          ...
          <el-form-item label="您的性别">
            <el-radio-group v-model="userQuizForm.parentGender">
              <el-radio  style="display:block;margin:10px 0px;" :label="1">爸爸</el-radio>
              <el-radio  style="display:block;margin:10px 0px;" :label="0">妈妈</el-radio>
            </el-radio-group>
          </el-form-item>
          ...
          <el-form-item>
            <a class="ui button olive" @click="submitForm('userQuizForm')">开始测试</a>
          </el-form-item>
        </el-form>
      ...
      let vm = this
       vm.$refs[formName].validate((valid) => {
         if (valid) {
          ...
          vm.$store.state.campaign.CAMPAIGN_DATA.local = vm.userQuizForm
         } else {
